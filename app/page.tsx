        ...
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
          ...
          <div className="mt-5 max-w-2xl text-center mx-auto">
            <h1 className="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-neutral-200">
              ...
              <span className="bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent"> AI Career Coach Agent</span>
            </h1>
          </div>
          ...
          <div className="mt-5 max-w-3xl text-center mx-auto">
            ...
            Smarter career decisions start here - get tailored advice, real time market insights, and a roadmap for you with the power of AI.</p>
          </div>
        ...
        <div className="grid sm:grid-cols-1 lg:grid-cols-3 items-center gap-2">
          ...
          <a className="group flex flex-col justify-center hover:bg-gray-50 rounded-xl p-4 md:p-7 dark:hover:bg-neutral-800" href="#">
            ...
            <div className="mt-5">
              ...
              <p className="mt-1 text-gray-600 dark:text-neutral-400">Ask career related questions and get instant AI guidance in jobs, skills and trends</p>
          ...
          <a className="group flex flex-col justify-center hover:bg-gray-50 rounded-xl p-4 md:p-7 dark:hover:bg-neutral-800" href="#">
            ...
            <div className="mt-5">
              ...
              <p className="mt-1 text-gray-600 dark:text-neutral-400">Receive Personalized career roadmap based on your goals and skills</p>
          ...
          {/* <a className="group flex flex-col justify-center hover:bg-gray-50 rounded-xl p-4 md:p-7 dark:hover:bg-neutral-800" href="#">
            ...
            <div className="mt-5">
              <h3 className="group-hover:text-gray-600 text-lg font-semibold text-gray-800 dark:text-white dark:group-hover:text-gray-400">AI Cover Letter Generator</h3>
              <p className="mt-1 text-gray-600 dark:text-neutral-400">Instantly create compelling and customized cover letters with AI</p>
